...
% genre_ind = [74, 16, 26, 71, 36, 3, 32, 22, 62];
genre_ind = [74, 16, 71, 36, 3, 22];
...
for qq = 1:length(genre_ind)
    ...
    eval(['save Perror/PeMoR_' num2str(qq) '_eps_' num2str(eps2t) '_HU.dat data2save1 -ascii'])

    data2save2(:,1) = Nv';
    data2save2(:,2) = PeRoS(:,10);
    data2save2(:,3) = PeRoS_Bound(:,10);
    eval(['save Perror/PeRoS_' num2str(qq) '_eps_' num2str(eps2t) '_HU.dat data2save2 -ascii'])
...
print(gcf, '-dpng', 'histogram_Rs_HU.png','-r600');
