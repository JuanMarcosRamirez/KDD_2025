...
for qq = 1:length(genre_ind)
    ...
    eval(['save Perror/PeMoR_' num2str(qq) '_eps_' num2str(eps2t) '_RO.dat data2save1 -ascii'])

    data2save2(:,1) = Nv';
    data2save2(:,2) = PeRoS(:,10);
    data2save2(:,3) = PeRoS_Bound(:,10);
    eval(['save Perror/PeRoS_' num2str(qq) '_eps_' num2str(eps2t) '_RO.dat data2save2 -ascii'])
...
print(gcf, '-dpng', 'histogram_Rs_RO.png','-r600');
